 ...
 * Created by Liviu Cerchez (http://cerchez.com/)
 */
(function (a) {
    a.fn.panorama360 = function (b) {
        ...
        function d(a, b, c, d) {
            ...
            a.parent().trigger("PANORAMA360_POSITION", e);
        }
        ...
        return this.each(function () {
            ...
            if (!(0 >= f.image_width && 0 >= f.image_height) || (
                f.image_width = parseInt(i.data("width")), f.image_height = parseInt(i.data("height")), f.image_width && f.image_height)) {
                var o, k = f.image_height / f.image_width,
                    ...
                    r = 0,
                    s = !1;
                if (f.is360 && i.removeAttr("usemap").css("left", 0).clone().css("left", m + "px").insertAfter(i),
                    h.css({ "margin-left": "-" + f.start_position + "px", width: 2 * m + "px", height: l + "px" }),
                    setInterval(function () {
                        return p ? !1 : (-2 > r || r > 2 ? r *= .98 : r = f.sliding_direction ? 2 * -f.sliding_direction : 0, r && d(h, m, r, f), void 0)
                    },f.sliding_interval),
                    g.unbind("mousedown mouseup mousemove mouseout mousewheel contextmenu touchmove touchend"),
                    g.mousedown(function (b) {
                    return p ? !1 : (a(this).addClass("grab")
                    ,
                    p = !0
                    ,
                    q = b.clientX
                    ...
                    if (!f.use_mouse_wheel) {
                        ...
                        return p ? !1 : (p = !0, q = a.originalEvent.touches[0].pageX, cacca = a.originalEvent.touches[0].pageY, scrollOffset = 0, void 0)
                }).bind("touchmove", function (a) {
                    var difX = a.originalEvent.touches[0].pageX - q;
                    var difY = a.originalEvent.touches[0].pageY - y;
                    if (Math.abs(difX) > Math.abs(difY)) { a.preventDefault() }

                    //a.preventDefault()
                    if (!p) { return !1; }
                    
                    f.sliding_direction = -1;
                    ...
                    p = !1,
                    f.sliding_direction && (f.sliding_direction = r > 0 ? -1 : 1),
                    r = .45 * r,
                    f.sliding_direction = 0
                        ...
                        switch (a(this).attr("shape").toLowerCase()) {
                            case "rect":
                                var b = a(this).attr("coords").split(","),
                                    c = a(document.createElement("a")).addClass("area").attr("href", a(this).attr("href")).attr("title", a(this).attr("alt")).attr("rel", a(this).attr("rel")).attr("name", a(this).attr("name"));
